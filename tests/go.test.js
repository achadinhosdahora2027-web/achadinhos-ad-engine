...
(async () => {
  ...
  assert.ok(r1.location.includes('sid=nexus_header'), 'Missing dynamic SID nexus_header');
  ...
  assert.ok(r2.location.includes('sid=solvegrid_inline'), 'Missing dynamic SID solvegrid_inline');
  ...
  assert.ok(r3.location.includes('sid=aquitemachadinhos_rectangle'));
